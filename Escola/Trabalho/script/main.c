...
void PreencheMapa(char mapa[ALTURA_MAX][LARGURA_MAX], int altura, int largura, tJogador jogador, tInimigo inimigo, tTiro tiro)
{
    // Para preencher o mapa, eh necessario o layout do mapa, especificacoes do tamanho e os componentes do mapa
...
bool HouveColisao(tPosicao tiro, tPosicao inimigo)
{
     /*
        ...
        A colisao eh detectada comparando as posiçoes do tiro e do inimigo em diversas combinações.
...
int InimigosRestantes(tInimigo inimigo)
{
    /*
        ...
        verificando se a posiçao x do inimigo eh diferente de -1 (inimigo ainda esta na tela).
    */
    int total = 0;
    for (int i = 0; i < inimigo.totalInimigosLinha1; i++)
    {
...
tInformacoes AdicionaPontos(tInformacoes info, tPosicao inimigo, tPosicao tiro, int altura)
{
    /*
        ...
        A pontuaçao eh calculada com base na posiçao do inimigo e na altura do mapa.
    */
...
{
    /*
        Esta funcao altera a posiçao dos inimigos no mapa.
        ...
        Atualiza a posiçao dos inimigos e retorna a estrutura atualizada.
    */
...
void PrintaResumoInimigoLateral(FILE *diretorio, int iteracao, int largura, tInimigo inimigo)
{
    ...
    */
    ...
    // * (-1) pq o coeficiente ja foi invertido na iteraçao atual
